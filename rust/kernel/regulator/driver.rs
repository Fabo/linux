...
pub trait Operations {
    ...
    fn set_voltage(_rdev: &Regulator, _min_uv: i32, _max_uv: i32) -> Result<u32> {
        Err(ENOTSUPP)
    }
    ...
    fn set_input_current_limit(_rdev: &Regulator, _lim_ua: i32) -> Result {
        Err(ENOTSUPP)
    }
    ...
    fn get_error_flags(_rdev: &Regulator) -> Result<u32> {
        Err(ENOTSUPP)
    }
    ...
    fn set_voltage_time(_rdev: &Regulator, _old_uv: i32, _new_uv: i32) -> Result<Duration> {
        Err(ENOTSUPP)
    }
    ...
    fn set_soft_start(_rdev: &Regulator) -> Result {
        Err(ENOTSUPP)
    }
    ...
    /// parameters.
    fn get_optimum_mode(_rdev: &Regulator, _input_uv: i32, _output_uv: i32, _load_ua: i32) -> Mode {
        Mode::Invalid
    }

    /// Set the load for the regulator.
    fn set_load(_rdev: &Regulator, _load_ua: i32) -> Result {
        Err(ENOTSUPP)
    }

    /// Set the regulator in bypass mode.
    fn set_bypass(_rdev: &Regulator, _enable: bool) -> Result {
        Err(ENOTSUPP)
    }

    /// Get the regulator bypass mode state.
    fn get_bypass(_rdev: &Regulator) -> Result<bool> {
        Err(ENOTSUPP)
    }
    ...
    fn resume(_rdev: &Regulator) -> Result {
        Err(ENOTSUPP)
    }

    /// Configure the regulator to pull down when the regulator is disabled.
    fn set_pull_down(_rdev: &Regulator) -> Result {
        Err(ENOTSUPP)
    }
}
...
///
///
pub struct Regulator(*mut bindings::regulator_dev);
impl Regulator {
    ...
    pub fn data<T: ForeignOwnable>(&self) -> T::Borrowed<'_> {
        unsafe { T::borrow(bindings::rdev_get_drvdata(self.0)) }
    }
}

/// Helper functions to implement some of the [`Operations`] using regmap
///
/// This trait is implemented by [`Regulator`] and is not meant to be implemented by anyone else.
pub trait RegmapHelpers: crate::private::Sealed {
    /// Implementation of [`Operations::get_voltage_sel`] using regmap
    fn get_voltage_sel_regmap(&self) -> Result<i32>;
    /// Implementation of [`Operations::set_voltage_sel`] using regmap
    fn set_voltage_sel_regmap(&self, sel: u32) -> Result;

    /// Implementation of [`Operations::is_enabled`] using regmap.
    ///
    ...
    /// Implementation of [`Operations::enable`] using regmap.
    ///
    /// [`Desc::with_enable`] or [`Desc::with_inverted_enable`] must have been called
    /// to setup the fields required by regmap.
    fn enable_regmap(&self) -> Result;

    /// Implementation of [`Operations::disable`] using regmap.
    ///
    /// [`Desc::with_enable`] or [`Desc::with_inverted_enable`] must have been called
    /// to setup the fields required by regmap.
    fn disable_regmap(&self) -> Result;

    /// Implementation of [`Operations::set_active_discharge`] using regmap
    ///
    ...
    /// Implementation of [`Operations::set_current_limit`] using regmap
    fn set_current_limit_regmap(&self, min_ua: i32, max_ua: i32) -> Result;
    /// Implementation of [`Operations::get_current_limit`] using regmap
...
impl<T: Operations> OperationsVtable<T> {
    ...
    unsafe extern "C" fn set_input_current_limit_callback(
        ...
        let rdev = ManuallyDrop::new(Regulator(rdev));
        from_result(|| {
            T::set_input_current_limit(&rdev, lim_ua)?;
            Ok(0)
        })
    }
    ...
    unsafe extern "C" fn set_over_current_protection_callback(
        ...
        let rdev = ManuallyDrop::new(Regulator(rdev));
        from_result(|| {
            T::set_over_current_protection(&rdev, lim_ua, severity, enable)?;
            Ok(0)
        })
    }
    ...
    unsafe extern "C" fn set_over_voltage_protection_callback(
        ...
        let rdev = ManuallyDrop::new(Regulator(rdev));
        from_result(|| {
            T::set_over_voltage_protection(&rdev, lim_uv, severity, enable)?;
            Ok(0)
        })
    }
    ...
    unsafe extern "C" fn set_under_voltage_protection_callback(
        ...
        let rdev = ManuallyDrop::new(Regulator(rdev));
        from_result(|| {
            T::set_under_voltage_protection(&rdev, lim_uv, severity, enable)?;
            Ok(0)
        })
    }
    ...
    unsafe extern "C" fn set_thermal_protection_callback(
        ...
        let rdev = ManuallyDrop::new(Regulator(rdev));
        from_result(|| {
            T::set_thermal_protection(&rdev, lim, severity, enable)?;
            Ok(0)
        })
    }
    ...
    unsafe extern "C" fn set_ramp_delay_callback(
        ...
        let rdev = ManuallyDrop::new(Regulator(rdev));
        from_result(|| {
            T::set_ramp_delay(&rdev, ramp_delay)?;
            Ok(0)
        })
    }
    ...
    unsafe extern "C" fn set_voltage_time_callback(
        ...
        let rdev = ManuallyDrop::new(Regulator(rdev));
        from_result(|| {
            T::set_voltage_time(&rdev, old_uv, new_uv)?;
            Ok(0)
        })
    }
    ...
    unsafe extern "C" fn set_voltage_time_sel_callback(
        ...
        let rdev = ManuallyDrop::new(Regulator(rdev));
        from_result(|| {
            T::set_voltage_time_sel(&rdev, old_selector, new_selector)?;
            Ok(0)
        })
    }
    ...
    unsafe extern "C" fn get_optimum_mode_callback(
        ...
        let rdev = ManuallyDrop::new(Regulator(rdev));
        T::get_optimum_mode(&rdev, input_uv, output_uv, load_ua) as _
    }
