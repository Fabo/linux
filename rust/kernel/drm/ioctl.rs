...
/// Descriptor type for DRM ioctls. Use the `kernel::declare_drm_ioctls` macro to construct them.
...
/// Internal structures used by the [`kernel::declare_drm_ioctls`] macro. Do not use directly.
#[doc(hidden)]
pub mod internal {
